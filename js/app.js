(function(){
  ...
  function zoomToPanel(page, panel){
    ...
    var width_multiplier = 1 / (tn_width / CONFIG.full_width); // Scale the width of the page by this to expand the target panel to full view
        y_adjuster = viewport_middle - tn_top - tn_middle;

    console.log(viewport_middle);
    ...
    $currentPage.css('transform', 'scale('+ width_multiplier + ', '+width_multiplier+') translate(0, '+y_adjuster+'px)');
