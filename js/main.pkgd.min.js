...
(function(){"use strict";var e=Backbone.Model.extend({initialize:function(){this.set("single-page-width",parseInt($("#pages").css("max-width"))),this.set("format",{}),this.set("zoom",null)},setPageFormat:function(e){this.set("format",this.determineLayoutInformation(e))},determineLayoutInformation:function(e){var t=this.determineBookend(e),a=this.determinePageFormat();return{format:a,bookend:t}},determinePageFormat:function(e){e=e||$(window).width();var t,a=parseInt($(".page-container.viewing img").css("width"))||parseInt($(".page-container img").css("width")),n=(this.get("single-page-width"),g.singlePageWidthLimit);return t=e>2*a+g.gutterWidth?"double":n>=e?"mobile":"single"},determineBookend:function(e){var t,n=e||a.currentPage;return t=1==n?"true":"false"}}),t=new e,a={currentPage:"1",currentHotspot:"",lastPage:"",lastHotspot:"",scaleMultiplier:1,firstRun:!0,showNavHelpers:!0},n={setTransitionCss:function(e,t,a){var o={};return o[e]=t,o=n.addDuration(o,a)},addDuration:function(e,t){var a=t?g.transitionDuration+"ms":0;return _.extend(e,{"transition-duration":a}),e},saveCurrentStates:function(e,n,o){var r=t.get("format"),i=r.format,s=r.bookend;"double"==i&&"false"==s&&e%2!=0&&(e-=1),e&&(a.currentPage=e),n&&(a.currentHotspot=n),o&&(a.lastPage=o)},hashToPageHotspotDict:function(e){return e=e.replace("#","").split("/"),e=_.map(e,function(e){return Number(e)}),{page:e[0],hotspot:e[1]}},getNavDirection:function(e,t){var a;return 37==t||38==t||39==t||40==t||"swipeleft"==t||"swiperight"==t?(e.preventDefault(),e.stopPropagation(),37==t||"swiperight"==t?a="prev":39==t||"swipeleft"==t?a="next":(27==t||38==t||40==t)&&(a=!1),a):!1},toggleFullScreen:function(){document.fullScreenElement&&null!==document.fullScreenElement||!document.mozFullScreen&&!document.webkitIsFullScreen?document.documentElement.requestFullScreen?document.documentElement.requestFullScreen():document.documentElement.mozRequestFullScreen?document.documentElement.mozRequestFullScreen():document.documentElement.webkitRequestFullScreen&&document.documentElement.webkitRequestFullScreen(Element.ALLOW_KEYBOARD_INPUT):document.cancelFullScreen?document.cancelFullScreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitCancelFullScreen&&document.webkitCancelFullScreen()},sortByNumber:function(e,t){return e.number-t.number}},o={pageFactory:_.template($("#page-template").html()),endnoteFactory:_.template($("#endnote-template").html())},r={init:function(){this.mainContent="#main-content-wrapper",this.drawerContainer="#side-drawer-container",this.drawerContent="#side-drawer-content",this.drawerHandle="#side-drawer-handle",this.pubDate=".pub-date-js",$.detectSwipe.scrollExceptionCondition=function(){return"true"==$("body").attr("data-side-drawer-open")||"changing"==$("body").attr("data-side-drawer-state")},this.slideContentArea(!0),this.bakePubDate()},bakeMasks:function(){$("#pages").append('<div class="mask" data-orientation="horizontal" id="top-mask"></div>').append('<div class="mask" data-orientation="horizontal" id="bottom-mask"></div>').append('<div class="mask" data-orientation="vertical" id="left-mask"></div>').append('<div class="mask" data-orientation="vertical" id="right-mask"></div>')},bakePages:function(e){var t,s;a.pages_max=e.length,e=e.sort(n.sortByNumber);var d=$('.header-item[data-which="page-number"]');d.find("#pages-max").html(a.pages_max),d.find("input").attr("max",a.pages_max);for(var c=0;c<e.length;c++)_.extend(e[c],{img_format:g.imgFormat}),t=o.pageFactory(e[c]),$("#pages").append(t),s=$("#page-"+e[c].number),i.hotspotClicks(s),i.pageTransitions();$("#page-container-"+a.pages_max).css("z-index","1000"),i.state(),r.measurePageElements(function(){l.init()})},measureHotspotsHeaderOffset:function(){$("#pages").attr("data-offset-top",$("#pages").offset().top),$(".hotspot").each(function(e,t){var a=$(t);a.attr("data-top",a.offset().top),a.attr("data-left",a.offset().left),a.attr("data-width",a.width()),a.attr("data-height",a.height())})},measurePageElements:function(e){r.measureImgSetPageHeight(function(){r.measureHotspotsHeaderOffset(),e()})},measureImgSetPageHeight:function(e){var a=$("#pages"),n=$("#pages-wrapper"),o={"max-width":"auto","max-height":"auto"};a.css(o),n.css(o),a.imagesLoaded().done(function(){var o=a.find("img"),r=o.width(),i=r,s=r,d=o.height();t.setPageFormat();var l=t.get("format").format;"double"==l&&(r=2*r,s=r+g.gutterWidth,"Firefox"==m.browser[0]&&(s-=1),$(".bookend-mask").width(i));var c=[{el:a,width:r},{el:n,width:s}];_.each(c,function(e){e.el.css("max-width",e.width+"px").css("max-height",d+"px")}),$("#btns").css("height",d+"px");var u=_.max([960,r]);$("#header").css("max-width",u+"px"),e()})},implementPageFormat:{bookend:function(){"2"==a.currentPage?$("#page-container-3").addClass("exit-to-right").addClass("right-page"):"1"!=a.currentPage&&$("#page-container-"+(a.currentPage+1)).addClass("exit-to-right")},mobile:function(){this.single()},single:function(){$(".right-page").removeClass("viewing").removeClass("right-page")},"double":function(){var e,n,o=t.get("format");o.bookend;a.hotspot="",a.lastHotspot="",n=+a.currentPage,n%2!=0&&1!=n&&n--,e=$("#page-container-"+n),e.hasClass("right-page")&&e.removeClass("right-page"),e.addClass("viewing"),1!=n&&$("#page-container-"+(n+1)).addClass("right-page").addClass("viewing")}},update:function(){t.setPageFormat();var e=t.get("format"),o=e.format;2==a.currentPage&&"double"==o&&r.toggleNavHelpers(!1);var i=$("#page-"+a.currentPage);c.toPage(i,!1),r.measurePageElements(function(){l.set.prune();var e=window.location.hash;if(e){var t=n.hashToPageHotspotDict(e);r.showAppropriateNavBtns(t.page),l.read(t.page,t.hotspot,!1)}})},displayPageNumber:function(e){e=+e;var a=t.get("format"),n=a.format;"double"==n&&e>1&&e%2!=0&&(e-=1),$('.header-item[data-which="page-number"] .header-text input').val(e)},showAppropriateNavBtns:function(e){e=+e;var n,o=t.get("format").format;1==e?n="prev":(e==a.pages_max||"double"==o&&e==a.pages_max-1)&&(n="next"),$(".main-nav-btn-container").removeClass("full").css("display","inline-block"),n&&($('.main-nav-btn-container[data-dir="'+n+'"]').hide(),$('.main-nav-btn-container[data-dir="'+this.otherDir(n)+'"]').addClass("full"))},otherDir:function(e){return"prev"==e?"next":"next"==e?"prev":void 0},toggleNavHelpers:function(e){$(".nav-helpers").toggle(e)},navHelpersMode:function(e){$(".nav-helpers-child").hide(),$('.nav-helpers-child[data-mode="'+e+'"]').show()},toggleDesktopDrawer:function(){$("#desktop-drawer-container").toggle()},bakeEndnotes:function(e){e.sort(n.sortByNumber),_.each(e,function(e){var t=o.endnoteFactory({endnote:e});$(".endnotes").append(t)})},catchDrawerScroll:function(e){"true"==$("body").attr("data-side-drawer")&&(!$(r.drawerContent).has($(e.target)).length||$(r.drawerContent).height()<$(r.drawerContainer).height())&&(e.preventDefault(),r.slideContentArea())},slideContentArea:function(e){var t=$("body"),a=t.attr("data-side-drawer-state");a&&t.attr("data-side-drawer-state","changing"),e=e||"true"==t.attr("data-side-drawer-open"),t.attr("data-side-drawer-open",!e),_.delay(this.onDrawerTransitionEnd,g.drawerTransitionDuration)},onDrawerTransitionEnd:function(e){$("body").attr("data-side-drawer-state","stable")},dragDrawer:function(e){e.preventDefault(),e.stopPropagation();var t=e.originalEvent,a=Number(t.changedTouches[0].pageX);this.last_x=this.last_x||a;var n=this.last_x-a,o=+$("#main-content-wrapper").css("transform").match(/(-?[0-9\.]+)/g)[4];return $('body[data-side-drawer-open="true"]	#main-content-wrapper').css({"transition-duration":"0",transform:"translateX("+(o-n)+"px)"}),this.last_x=a,!1},snapDrawer:function(){this.last_x=!1,$(r.mainContent).css({"transition-duration":g.drawerTransitionDuration,transform:"auto"}),r.slideContentArea(!0)},goToPage:{focus:function(e,t){},navigate:function(e,t){var a=t.toString();e?l.router.navigate(a,{trigger:!0}):r.displayPageNumber(t),r.goToPage.focus(!1)},deny:function(){var e=a.currentPage;r.displayPageNumber(e)}},fullScreenChange:function(){document.fullScreenElement&&null!==document.fullScreenElement||!document.mozFullScreen&&!document.webkitIsFullScreen?mode="exit":mode="enter"},bakePubDate:function(){$(this.pubDate).html(g.pubDate)}},i={header:function(){$('.header-item-container[data-btn="fullscreen"]').on("click",function(){n.toggleFullScreen()}),$('.btn-dropdown[data-which="alt-formats"] a,.drawer-section-container[data-section="downloads"] a').on("click",function(){return!0}),$(".endnotes").on("click","a",function(){return!0}),$('.header-item-container[data-action="drawer"], .section-title-close[data-action="drawer"]').on("click",function(){$('.header-item-container[data-action="drawer"]').toggleClass("active"),r.slideContentArea()}),$(".tooltipped-i input").on("focus",function(){var e=this;if(!window.getSelection().focusNode)try{e.setSelectionRange(0,999)}catch(t){$(e).select()}}),$(".tooltipped-i input").on("blur",function(){r.goToPage.deny()}),$('.header-item[data-which="page-number"] input').on("keydown",function(e){e.stopPropagation()}),$('.header-item[data-which="page-number"] input').on("keyup",function(e){e.stopPropagation();var t=+$(this).val()||1,n=e.keyCode,o=a.currentPage,i=o!=t;1>t?t=1:t>a.pages_max&&(t=a.pages_max),r.goToPage.focus(i,!0),t&&13===n?(r.goToPage.navigate(i,t),$(".tooltipped-i input").blur()):27==n&&r.goToPage.deny()}),$(".social-btn").on("click",function(e){var t=$(this).attr("data-which");u.share[t](e)})},resize:function(){r.updateDebounce=_.debounce(r.update,500),window.addEventListener("resize",function(){r.updateDebounce()})},state:function(){t.on("change:format",function(e,t){$("body").attr("data-format",t.format),$("body").attr("data-bookend",t.bookend),"false"==t.bookend?r.implementPageFormat[t.format]():r.implementPageFormat.bookend()}),t.on("change:zoom",function(e,t){$("body").attr("data-state",t)})},hotspotClicks:function(e){e.on("click",".hotspot",function(){l.set.fromHotspotClick($(this))})},keyboardAndGestures:function(){$("body").keydown(function(e){var t=n.getNavDirection(e,e.keyCode);l.set.fromKeyboardOrGesture(t)}),$(document).on("swipeleft",function(e){var t=n.getNavDirection(e,"swipeleft");l.set.fromKeyboardOrGesture(t)}),$(document).on("swiperight",function(e){var t=n.getNavDirection(e,"swiperight");l.set.fromKeyboardOrGesture(t)}),$(document).on("pinchin pinchout",function(e){var t=a.currentPage,n=a.currentHotspot||"1",o=$('<div class="dummy-hotspot" data-hotspot-id="'+t+"-"+n+'"></div>');l.set.fromHotspotClick(o),o.remove()}),$(".main-nav-btn-container").on("click",function(){var e=$(this).attr("data-dir");l.set.fromKeyboardOrGesture(e)}),$("#pages").on("click",".mask",function(){l.set.fromHotspotClick($(this))}),$("#pages").on("click",'.internal-link[data-destination="endnotes"]',function(){$('.header-item-container[data-action="drawer"]').toggleClass("active"),r.slideContentArea()}),"desktop-hover"==g.panelZoomMode&&($("#pages").on("mouseout",".page",function(){var e=t.get("format"),a=e.format;"mobile"!=a&&$(this).find("img").css({transform:"translate(0%,0%)scale(1)"})}),$("#pages").on("mousemove",".page",function(e){var n=t.get("format"),o=n.format,r=n.bookend;if("mobile"!=o){var i,s,d=g.desktopHoverZoomOptions.scale,l=100*g.desktopHoverZoomOptions.fit,c=g.desktopHoverZoomOptions.padding,u=$(this),p=u.find("img"),m=p.width(),h=u.width(),f=u.height(),v=e.pageX-u.offset().left,w=e.pageY-u.offset().top,b=v/h,k=w/f;if(r&&"double"==o&&1==a.currentPage){if(i=(h-m)/2,s=i+m,i>v||v>s)return!0;h=h/2-g.gutterWidth}var C=l*((h*d-h)/2)/h,P=(new Scale).domain(1-c,c).range(-1*C,C,!0),x=P(b),y=P(k);p.css({transform:"matrix("+d+", 0, 0, "+d+", "+x/100*h+", "+y/100*f+")"})}}))},pageTransitions:function(){$(".page-container").on("animationend webkitAnimationEnd oAnimationEnd MSAnimationEnd",d.onAnimationEnd_throttled)},drawer:function(){new ScrollFix(document.getElementById("side-drawer-container")),$("body").on("touchmove",r.catchDrawerScroll),$(r.drawerHandle).on("touchstart touchmove",r.dragDrawer),$(r.drawerHandle).on("touchend",r.snapDrawer),$(r.drawerHandle).on("click",r.snapDrawer)},fullscreen:function(){document.addEventListener("webkitfullscreenchange",r.fullScreenChange,!1),document.addEventListener("mozfullscreenchange",r.fullScreenChange,!1),document.addEventListener("fullscreenchange",r.fullScreenChange,!1),document.addEventListener("MSFullscreenChange",r.fullScreenChange,!1)}},s={prev:{page:function(e){var n=t.get("format"),o=n.format,r=n.bookend;return 1!=e.page&&("double"!=o&&"false"==r?e.page--:2!=e.page?e.page=e.page-2:e.page=e.page-1),e.hotspot="",a.lastHotspot="",e},hotspot:function(e){var t;return e.hotspot--,e.hotspot<0?(e.hotspot="",1!=e.page&&(e.page--,t=Number($("#page-"+e.page).attr("data-length")),t&&(a.lastHotspot=t+1))):e.hotspot<1&&(a.lastHotspot="",e.hotspot=""),e}},next:{page:function(e,n,o){var r=1,i=t.get("format"),s=i.format,d=i.bookend;return"double"==s&&"false"==d&&(r=2),e.page+r<=o&&(e.page=e.page+r,a.lastHotspot=""),e.hotspot="",e},hotspot:function(e,t,a){return e.hotspot++,e.hotspot>t&&(e=s.next.page(e,null,a)),e}}},d={goIfNecessary:function(e,a){var n=t.get("format"),o=n.format,i=n.bookend;"double"==o&&"false"==i&&a%2!=0&&(a-=1,l.router.navigate(a.toString(),{replace:!0}),r.displayPageNumber(a));var s=this.determineTransition(e,a,o,i);s&&d.movePages(e,a,s)},determineTransition:function(e,t,a,n){var o;return("double"!=a||e-t!=1||"false"!=n)&&e!=t&&(o=t>e?d.moveForward():d.moveBack()),o},moveForward:function(){var e={exiting:"exit-to-left",entering:"enter-from-right"};return e},moveBack:function(){var e={exiting:"exit-to-right",entering:"enter-from-left"};return e},movePages:function(e,a,n){var o=t.get("format").format,r=t.get("format").bookend;if("double"!=o||"true"==r)$("#page-container-"+e).addClass(n.exiting),$("#page-container-"+a).addClass(n.entering);else{var i="";1==e&&(i=" center-page"),$("#page-container-"+e).addClass(n.exiting+i),$("#page-container-"+(e+1)).addClass(n.exiting),$("#page-container-"+a).addClass(n.entering).addClass("viewing"),$("#page-container-"+(a+1)).addClass(n.entering).addClass("right-page").addClass("viewing")}},onAnimationEnd:function(){$(".page-container").removeClass("enter-from-left").removeClass("enter-from-right").removeClass("exit-to-left").removeClass("exit-to-right").removeClass("center-page"),$("#page-container-"+a.lastPage).removeClass("viewing").find(".page").css(n.setTransitionCss("transform","scale(1)",!1));var e=t.get("format"),o=e.format,r=e.bookend;"double"==o&&"false"==r&&1!=a.lastPage?$("#page-container-"+(+a.lastPage+1)).removeClass("viewing").removeClass("right-page").find(".page").css(n.setTransitionCss("transform","scale(1)",!1)):"true"==r&&1==a.currentPage&&$("#page-container-"+(+a.lastPage+1)).removeClass("viewing").removeClass("right-page"),t.set("zoom","page")}},l={setInitRouteChecks:function(e,o,i){var s=!0,d=t.get("format"),l=d.format;if(o=o||a.firstRun,a.firstRun){var c=!1;(g.requireStartOnFirstPage||"1"==e)&&(e="1",c=!0),n.saveCurrentStates(e),s=!1,r.toggleNavHelpers(c),r.navHelpersMode("intro")}else a.showNavHelpers&&"2"==e&&"single"==l?(r.navHelpersMode("expand"),a.showNavHelpers=!1):r.toggleNavHelpers(!1);o&&this.lazyLoadImages(e),r.displayPageNumber(e),r.showAppropriateNavBtns(e),i(s,e)},lazyLoadImages:function(e){e=+e;var t=g.lazyLoadExtent,n=e-t,o=e+t;0>=n&&(n=1),o>a.pages_max&&(o=a.pages_max+1);for(var r,i,s,d,l,c,u=_.range(n,o),p=0;p<u.length;p++)r=u[p],i=$("#page-container-"+r),s=i.find("img"),c=s.attr("src"),c.indexOf("data:image/gif")>-1&&(d=r+"."+g.imgFormat,l="imgs/pages/page-"+d,s.attr("src",l))},init:function(){l.Router=Backbone.Router.extend({routes:{":page(/)":"page",":page/:hotspot":"hotspot"}}),l.router=new l.Router,l.router.on("route:page",function(e){l.setInitRouteChecks(e,!0,function(e,t){l.read(t,null,e)})}),l.router.on("route:hotspot",function(e,a){l.setInitRouteChecks(e,null,function(n){"all-devices"!=g.panelZoomMode&&"mobile"!=t.get("format").format&&(a=null,l.router.navigate(e,{replace:!0})),l.read(e,a,n)})}),Backbone.history.start(),l.onPageLoad(window.location.hash)},onPageLoad:function(e){var t;t=!e||g.requireStartOnFirstPage?"1":a.currentPage,l.router.navigate(t.toString(),{trigger:!0,replace:!0})},set:{fromHotspotClick:function(e){if("all-devices"==g.panelZoomMode||"mobile"==t.get("format").format){var n=e.attr("data-hotspot-id").split("-"),o=n[0],r=n[1],i="",s="";a.currentPage==o&&a.currentHotspot==r?(a.lastHotspot=r,a.currentHotspot=r="",i=o,s="zoom_out"):(i=o+"/"+r,s="zoom_in"),l.router.navigate(i,{trigger:!0})}},fromKeyboardOrGesture:function(e){if(e&&"page-change"!=$("body").attr("data-state")){var o,r=n.hashToPageHotspotDict(window.location.hash),i=Number($("#page-"+r.page).attr("data-length")),d=t.get("format"),c=d.format,u=d.bookend;r.page=r.page||1,r.hotspot=r.hotspot||a.lastHotspot||0,a.lastHotspot=r.hotspot,o="mobile"!=c&&"all-devices"!=g.panelZoomMode||"false"!=u?"page":"hotspot",r=s[e][o](r,i,a.pages_max);var p=r.page.toString();r.hotspot&&(p+="/"+r.hotspot),l.router.navigate(p,{trigger:!0})}},prune:function(){var e=n.hashToPageHotspotDict(window.location.hash);"mobile"!=t.get("format").format&&e.hotspot&&"all-devices"!=g.panelZoomMode&&(l.router.navigate(e.page.toString(),{replace:!0}),a.currentHotspot="")}},read:function(e,o,r){var i=$("#page-container-"+e);i.hasClass("viewing")||i.addClass("viewing"),a.firstRun&&(n.saveCurrentStates(e,o),a.firstRun=!1),e=+e,t.setPageFormat(e),d.goIfNecessary(+a.currentPage,e),"mobile"!=t.get("format").format&&"all-devices"!=g.panelZoomMode||!o?c.toPage($("#page-"+e),!0):c.toHotspot(e,o,r),n.saveCurrentStates(e,o,a.currentPage)}},c={toPage:function(e,a){var o=(e.attr("id").split("-")[1],n.setTransitionCss("transform","scale(1)",a));e.css(o);var r={opacity:0},i=_.extend({height:0},r),s=_.extend({width:0},r);i=n.addDuration(i,a),s=n.addDuration(s,a),$('.mask[data-orientation="horizontal"]').css(i),$('.mask[data-orientation="vertical"]').css(s);var d,l,c=t.get("format"),u=c.format;l="double"!=u?1:2;var g=$(".viewing").length;g==l?d="page":g>l&&(d="page-change"),t.set("zoom",d)},toHotspot:function(e,o,r){var i=$("#page-"+e),s=i.width(),d=i.height(),l=$(window).width()/2,u=d/2,g=+$("#pages").attr("data-offset-top"),p=$("#hotspot-"+e+"-"+o),m=Number(p.attr("data-top")),h=Number(p.attr("data-left")),f=Number(p.attr("data-width")),v=Number(p.attr("data-height")),w=f/2,b=v/2,k=this.calcScaleMultiplier(f,v,s,d),C=k.multiplier,P=k.orientation,x=l-h-w,y=u-m-b+g,S=n.setTransitionCss("transform","scale("+C+") translate("+x+"px, "+y+"px)",r);i.css(S),c.sizeMasks(f,v,s,d,C,r,P),c.applyHotspotIdToMasks(e,o),a.scaleMultiplier=C,t.set("zoom","hotspot")},sizeMasks:function(e,t,a,o,r,i,s){var d,l,c,u;"horizontal"==s?(d="height",l=(o-t*r)/2,c="vertical",u="width"):"vertical"==s&&(d="width",l=(a-e*r)/2,c="horizontal",u="height");var g={opacity:1};g[d]=l+"px",g=n.addDuration(g,i),$('.mask[data-orientation="'+s+'"]').css(g);var p={opacity:0};p[u]=0,p=n.addDuration(p,i),$('.mask[data-orientation="'+c+'"]').css(p)},applyHotspotIdToMasks:function(e,t){$(".mask").attr("data-hotspot-id",e+"-"+t)},calcScaleMultiplier:function(e,t,a,n){var o,r,i=["horizontal","vertical"],s=[];s.push(1/(e/a)),s.push(1/(t/n)),o=_.min(s);var d=s.indexOf(o);return r=i[d],{multiplier:o,orientation:r}}},u={init:function(){this.shareable_url="http://"+window.location.hostname+window.location.pathname},share:{twitter:function(e,t,a){var n="https://twitter.com/intent/tweet?url="+u.shareable_url;t=t||g.social.twitter_text,a&&(n+=a);var o="&text="+t,r=g.social.twitter_account,i="&related="+r,s="&counturl="+u.shareable_url,d=e.pageX-400,l=e.pageY-350,c=u.percentEncode(n+o+" via @"+r+i+s),p="width=500,height=300,top="+l+",left="+d+",scrollbars=no,location=0,statusbars=0,menubars=0,toolbars=0,resizable=0";window.open(c,"Tweet",p)},facebook:function(e,t,a){var n="http://www.facebook.com/dialog/feed",o="?app_id="+g.social.fb_app_id,r="&link="+u.shareable_url,t=t||g.social.fb_text,a=a||g.social.promo_img_url,i="&description="+t,s="&redirect_uri="+u.shareable_url,d="&image="+a,l=n+o+r+i+s+d,c=e.pageX-400,p=e.pageY-350,m=u.percentEncode(l),h="width=900,height=450,top="+p+",left="+c+",scrollbars=no,location=0,statusbars=0,menubars=0,toolbars=0,resizable=0";window.open(m,"Share",h)},gplus:function(e){var t="https://plus.google.com/share",a="?url="+u.shareable_url,n=t+a,o=u.percentEncode(n),r="width=600,height=600,scrollbars=yes,resizable=yes,toolbar=no,menubar=no";window.open(o,"Share",r)},reddit:function(e){var t="https://www.reddit.com/submit",a="?url="+u.shareable_url,n=t+a,o=u.percentEncode(n),r="width=600,height=600,scrollbars=yes,resizable=yes,toolbar=no,menubar=no";window.open(o,"Share",r)}},percentEncode:function(e){return e.replace(/#/g,"%23").replace(/,/g,"%2c").replace(/ /g,"%20")}},g={},p={init:function(e){$.getJSON("config.json").done(function(t){g=$.extend(!0,p.defaults,t),e()}).error(function(e){alert("Error loading config. File is either missing or the JSON is malformed. Try running `config.json` it through jsonlint.com")})},defaults:{imgFormat:"jpg",whitelabel:{files:{js:[]},logo:""},panelZoomMode:"desktop-hover",desktopHoverZoomOptions:{scale:1.5,fit:1,padding:.25},lazyLoadExtent:6,transitionDuration:400,singlePageWidthLimit:635,gutterWidth:2,drawerTransitionDuration:500,social:{twitter_text:"THE TEXT TO DISPLAY WHEN SOMEONE CLICKS ON THE TWEET BUTTON",twitter_account:"THE RELATED TWITTER ACCOUNT.",fb_text:"THE TEXT TO DISPLAY WHEN SOMEONE CLICKS ON THE FACEBOOK SHARE BUTTON",promo_img_url:"PUBLISHED URL FOR IMAGE TO USE AS SOCIAL PROMO",fb_app_id:"YOUR FB APP ID"},requireStartOnFirstPage:!1}},m={go:function(){var e=this;p.init(function(){e.whitelabel(g.whitelabel),d.onAnimationEnd_throttled=_.throttle(d.onAnimationEnd,5),e.browser=e.browserCheck(),e.touch=e.touchCheck(),e.addMobileClass(),e.addPanelZoomModeClass(),r.init(),r.bakeMasks(),e.loadPages(),i.resize(),i.header(),i.keyboardAndGestures(),i.drawer(),i.fullscreen(),u.init(),FastClick.attach(document.body),e.browserHacks()})},loadPages:function(){$.getJSON("data/pages.json").done(function(e){var t=e.pages,n=e.endnotes;a.totalPages=t.length,r.bakePages(t),r.bakeEndnotes(n)}).error(function(e){alert("Error loading data. Data file is either missing or the JSON is malformed. Try running `pages.json` through jsonlint.com")})},browserCheck:function(){var e,t=navigator.userAgent,a=t.match(/(android|opera|chrome|safari|firefox|msie|trident(?=\/))\/?\s*(\d+)/i)||[];return/trident/i.test(a[1])?(e=/\brv[ :]+(\d+)/g.exec(t)||[],"IE "+(e[1]||"")):"Chrome"===a[1]&&(e=t.match(/\bOPR\/(\d+)/),null!=e)?"Opera "+e[1]:(a=a[2]?[a[1],a[2]]:[navigator.appName,navigator.appVersion,"-?"],null!=(e=t.match(/version\/(\d+)/i))&&a.splice(1,1,e[1]),a)},whitelabel:function(e){e&&(_.each(e.files,function(e,t){for(var a,n=0;n<e.length;n++)"js"==t&&(a='<script src="whitelabel/js/'+e[n]+'"></script>'),"css"==t&&(a='<link rel="stylesheet" type="text/css" href="whitelabel/css/'+e[n]+'" />'),document.write(a)}),$("#header").append(e.logo))},browserHacks:function(){"Android"==this.browser[0]&&$("#page-number-input").attr("type","text"),this.touch&&$(".nav-helpers").remove()},touchCheck:function(){return"ontouchstart"in window||"onmsgesturechange"in window},addMobileClass:function(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)&&$("body").addClass("mobile")},addPanelZoomModeClass:function(){$("body").attr("data-panel-zoom-mode",g.panelZoomMode)}};m.go()}).call(this);
